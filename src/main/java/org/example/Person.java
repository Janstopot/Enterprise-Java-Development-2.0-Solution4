...
public class Person {
    ...
    public static Person clone(Person person){
        Person clone = new Person(person.id + 1, person.name, person.age, person.occupation);
        return  clone;
    ...
    public void setAge(int age) {
        if(age < 0) throw new IllegalArgumentException("La edad no puede ser menos que 0");
        this.age = age;
    }
